...
enum Suit{DIAMOND(1),CLUB(2),HEART(3),SPADE(4);
private final int suitValue;
Suit(final int suitValue){this.suitValue = suitValue;}
public int getSuitValue(){return this.suitValue;} 
};

public Card(final Rank rank, final Suit suit){this.rank = rank; this.suit = suit;}
...
private static String cardKey(final Rank rank, final Suit suit){return rank +" of "+suit;}
